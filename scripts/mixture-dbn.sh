...
run_name="dbn"
user_model="mixture-dbn"
query_dist="uniform"

# Train all seven click models on user behavior following a mixture of DBNs, simulating
# a horizontal layout where people can start scrolling from both ends of a ranking.
